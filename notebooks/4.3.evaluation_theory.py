...
# MAGIC
# MAGIC Traditional ML evaluation (accuracy, F1, etc.) doesn't work well for GenAI
# MAGIC because:
# MAGIC
# MAGIC ### Challenges:
...
quality_judge = make_judge(
    ...
    instructions=(
        "Evaluate the quality of the response in {{ outputs }} to the question in "
        "{{ inputs }}. "
        "Score from 1 to 5:\n"
...
judge_test_data = [
    ...
    {
        "inputs": {"question": "What is machine learning?"},
        "outputs": "Machine learning is a subset of AI where algorithms learn patterns"
...
comprehensive_test_data = [
    {
        ...
        "outputs": "Transformers are a neural network architecture that uses"
        "self-attention mechanisms to process sequential data. They've revolutionized NLP"

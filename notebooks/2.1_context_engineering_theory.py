...
# MAGIC
# MAGIC **Context Engineering** is the practice of providing relevant information to
# MAGIC LLMs to improve their responses.
# MAGIC
...
def rewrite_query(original_query: str) -> list[str]:
    ...
    prompt = f"""Given this search query, generate 3 alternative phrasings that would
...
def create_rag_prompt(query: str, context_chunks: list[str]) -> str:
    ...
    prompt = f"""Use the following context to answer the question. If the answer is
not in the context, say "I don't have enough information to answer that."

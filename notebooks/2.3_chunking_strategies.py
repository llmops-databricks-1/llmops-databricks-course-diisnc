...
# MAGIC
# MAGIC 1. **Embedding Generation**: Most embedding models have token limits
# MAGIC (512-8192 tokens)
...
# Load chunks from the chunks_table table created in Lecture 2.2
...
# MAGIC
# MAGIC While AI Parse Documents provides intelligent chunking, let's explore

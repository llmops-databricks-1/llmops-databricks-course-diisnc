...
Derive a job resource key from the notebook filename: take the filename without extension, replace hyphens with underscores, append `_job`. Ignore numbers in the notebook name.
